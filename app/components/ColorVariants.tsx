        ...
        <section className="px-6 py-28">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-4xl md:text-6xl font-bold tracking-tight leading-tight mt-8 mb-4">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {/* White variant */}
                    <div className="group">
                        <div className="relative w-full aspect-square rounded-2xl overflow-hidden bg-slate-100 mb-6">
                            <Image
                        ...
                        <div className="flex items-center gap-3 mb-2">
                            <span className="w-5 h-5 rounded-full bg-white border-2 border-slate-200 shadow-sm" />
                            <h3 className="text-xl font-bold tracking-tight">Arctic White</h3>
                        </div>
                    ...
                    <div className="group">
                        ...
                        <div className="flex items-center gap-3 mb-2">
                            <span className="w-5 h-5 rounded-full bg-[#c5a355] border-2 border-[#c5a355]/30 shadow-sm" />
                            <h3 className="text-xl font-bold tracking-tight">Royal Gold</h3>
                        </div>
                        <p className="text-sm text-slate-400 leading-relaxed">
                    ...
                    <div className="group">
                        ...
                        <div className="flex items-center gap-3 mb-2">
                            <span className="w-5 h-5 rounded-full bg-[#8b1a1a] border-2 border-[#8b1a1a]/30 shadow-sm" />
                            <h3 className="text-xl font-bold tracking-tight">Crimson Red</h3>
                        </div>
                        <p className="text-sm text-slate-400 leading-relaxed">
                    ...
                    <div className="group">
                        ...
                        <div className="flex items-center gap-3 mb-2">
                            <span className="w-5 h-5 rounded-full bg-[#1a3a6e] border-2 border-[#1a3a6e]/30 shadow-sm" />
                            <h3 className="text-xl font-bold tracking-tight">Deep Blue</h3>
                        </div>
                        <p className="text-sm text-slate-400 leading-relaxed">
