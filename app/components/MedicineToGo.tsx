        ...
        <section className="relative px-6 py-32 overflow-hidden">
            ...
            <div className="relative z-10 max-w-7xl mx-auto">
                <div className="max-w-xl">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 mb-10">
                    ...
                    <div className="grid grid-cols-3 gap-6 mb-12">
                        {[
                            ...
                            <div key={i}>
                                ...
                                <p className="text-[11px] text-white/40 uppercase tracking-wide mt-1">{stat.label}</p>
                            </div>
                        ))}
                    </div>
