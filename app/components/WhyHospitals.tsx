            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mt-10 mb-16">
                    <h2 className="text-4xl md:text-6xl font-bold tracking-tight leading-tight mb-4">
                        Hospitals Aren&apos;t Buying Hardware.<br />They&apos;re Investing in Leadership.
                    </h2>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
                    {[
                        ...
                        <div key={i} className="rounded-2xl border border-slate-200 bg-slate-50 p-6">
                            <div className="w-10 h-10 rounded-full bg-[#4159ff]/15 border border-[#4159ff]/20 grid place-items-center mb-4">
