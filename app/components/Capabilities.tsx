        ...
        <section id="capabilities" className="px-6 py-28">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mt-10 mb-16">
                    ...
                    <p className="text-base text-slate-400 mt-4 max-w-xl">Every component hand-selected, stress-tested, and validated for the most demanding clinical environments on earth.</p>
                </div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
                    {capabilities.map((cap, i) => (
                        <GlassCard key={i}>
                            ...
                            <p className="text-sm text-slate-400 leading-relaxed">{cap.text}</p>
                        </GlassCard>
                    ))}
                </div>
                ...
                <div className="mt-14 text-center">
                    ...
                    <p className="text-xs text-slate-400 mt-3">Limited first batch. <span className="font-semibold text-[#4159ff]">$500 for the first 1,000 physicians.</span></p>
                </div>
            </div>
        </section>
    );
