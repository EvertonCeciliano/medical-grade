...
export default function Waitlist() {
    ...
    return (
        <section id="waitlist" className="px-4 sm:px-6 py-8 sm:py-28">
                ...
                <div className="grid lg:grid-cols-2 gap-8 sm:gap-16 lg:gap-24 items-start">
                    ...
                    <div>
                        ...
                        <div className="rounded-2xl bg-gradient-to-br from-[#4159ff]/10 to-[#4159ff]/5 border border-[#4159ff]/20 p-5 sm:p-6 mb-5 sm:mb-8">
                            ...
                            <p className="text-xs sm:text-sm font-semibold text-slate-700 mb-2">First 1,000 clients get Medicync laptop at this price.</p>
