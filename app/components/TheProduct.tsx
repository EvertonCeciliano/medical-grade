    ...
    return (
        <section className="px-6 py-28">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="relative w-full aspect-[16/9] rounded-3xl overflow-hidden mt-14">
                    <Image src="/notebook-white-home.png" alt="Medicync in home office" fill className="object-cover" />
                    <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/60 to-transparent pt-20 pb-8 px-8">
